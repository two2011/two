...
public class PlayersFightTest {
    ...
    public void hitToKill() {
        ...
        verify(dispatcher).dispatch(
                new SendMessageToUserCommand(player1, "Wygrales! Zdobyles 0 pkt doswiadczenia.", MessageType.INFO));
    ...
    @Test
    public void shouldAddExperienceToPlayerWhoWonFightAndSendMessage() throws Exception {
        // GIVEN
        Service service = mock(Service.class);
        player1 = mock(IPlayer.class);
        player2 = mock(IPlayer.class);
